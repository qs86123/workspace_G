...
public class WebLogin {
    ...
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(WebLogin.class);

    public static String loginweb(String cookie) {
        //设置基本信息
        ...
        final String url = "https://182.140.197.53/64a0a160/userLogin.action";
        List<NameValuePair> list = new ArrayList<NameValuePair>();
        String userName = "B051001705708";
        String password = "CH2410616@";
        list.add(new BasicNameValuePair("userName", userName));
        list.add(new BasicNameValuePair("password", password));
        //添加请求参数
        MyQuickCrawlUtil.INS.addPostParam(list);
        String webcookie = MyQuickCrawlUtil.INS.loginweb(url, null, null);
        //完成请求发送，并记录返回信息
