...
public abstract class ParseWorker {
    ...
    protected List<UsrCashMonth> userCashMonths = new ArrayList<>();
    ...
    public List<UsrCashMonth> getUserCashMonths() {
        return userCashMonths;
    }

    public void setUserCashMonths(List<UsrCashMonth> userCashMonths) {
        this.userCashMonths = userCashMonths;
    }
}
