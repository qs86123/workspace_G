...
public class VpnLogin {
    ...
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(VpnLogin.class);

    public static String loginvpn() {
        //设置基本信息
        ...
        final String url = "https://182.140.197.53/vpn/user/auth/password";
        List<NameValuePair> list = new ArrayList<NameValuePair>();
        String userName = "N051001705708";
        String password = "Ch-266095";
        list.add(new BasicNameValuePair("username", userName));
        list.add(new BasicNameValuePair("password", password));
        //添加请求参数
        MyQuickCrawlUtil.INS.addPostParam(list);
        String cookie = MyQuickCrawlUtil.INS.loginvpn(url, null, null);
        //完成请求发送，并记录返回信息
